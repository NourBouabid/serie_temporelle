...
Y=data["nombre_trajets"] # extration du processus stationnaire à étudier
...
model_train = sm.tsa.ARIMA(train, order=(2,0,2)).fit()
...
plt.legend()
plt.title("Prévisions ARMA(2,2) des données de test")
#plt.show()